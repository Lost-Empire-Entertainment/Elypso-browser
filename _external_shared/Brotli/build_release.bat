...
:: This batch file builds Brotli from source code using MSVC (cl.exe) for Release.

:: Set the root folder as the location of this script
set "BROTLI_ROOT=%~dp0"
set "BUILD_DIR=%BROTLI_ROOT%build-release"
set "INSTALL_DIR=%BROTLI_ROOT%install-release"
