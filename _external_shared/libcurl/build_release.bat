...
set "CURL_ROOT=%~dp0"
set "BUILD_DIR=%CURL_ROOT%build-release"
set "INSTALL_DIR=%CURL_ROOT%install-release"
...
echo ---------------------------------------------
echo Shared library: %INSTALL_DIR%\lib\libcurl.lib
echo Include headers: %INSTALL_DIR%\include\curl
