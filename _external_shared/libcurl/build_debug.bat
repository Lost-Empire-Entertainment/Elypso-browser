...
:: This batch file builds libcurl from source code using MSVC (cl.exe) for Debug.

:: Set the root folder as the location of this script
set "LIBCURL_ROOT=%~dp0"
set "BUILD_DIR=%LIBCURL_ROOT%build-debug"
set "INSTALL_DIR=%LIBCURL_ROOT%install-debug"

set "LIBCURL_LIB=%LIBCURL_ROOT%\..\LibPSL\debug\psl.lib"
set "LIBCURL_HEADERS=%LIBCURL_ROOT%\..\LibPSL"

set "NGHTTP2_LIB=%LIBCURL_ROOT%\..\NGHTTP2\debug\nghttp2.lib"
set "NGHTTP2_HEADERS=%LIBCURL_ROOT%\..\NGHTTP2"

set "BROTLI_DEC=%LIBCURL_ROOT%\..\Brotli\debug\brotlidec.lib"
set "BROTLI_COMMON=%LIBCURL_ROOT%\..\Brotli\debug\brotlicommon.lib"
set "BROTLI_HEADERS=%LIBCURL_ROOT%\..\Brotli"

set "ZSTD_LIB=%LIBCURL_ROOT%\..\Zstd\debug\zstd.lib"
...
:: Success message
echo [SUCCESS] libcurl built and installed successfully (Debug).
echo -------------------------------------------------
