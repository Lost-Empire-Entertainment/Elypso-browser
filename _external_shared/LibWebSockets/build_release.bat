...
:: This batch file builds libwebsockets from source code using MSVC (cl.exe) for Release.

:: Set the root folder as the location of this script
set "LIBWEBSOCKETS_ROOT=%~dp0"
set "BUILD_DIR=%LIBWEBSOCKETS_ROOT%build-release"
set "INSTALL_DIR=%LIBWEBSOCKETS_ROOT%install-release"
...
:: Success message
echo [SUCCESS] libwebsockets built and installed successfully.
echo -------------------------------------------------
