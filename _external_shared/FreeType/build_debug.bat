...
:: This batch file builds FreeType from source code using MSVC (cl.exe) for Debug.

:: Set the root folder as the location of this script
set "FREETYPE_ROOT=%~dp0"
set "BUILD_DIR=%FREETYPE_ROOT%build-debug"
set "INSTALL_DIR=%FREETYPE_ROOT%install-debug"
...
:: Success message
echo [SUCCESS] FreeType built and installed successfully (Debug).
echo -------------------------------------------------
