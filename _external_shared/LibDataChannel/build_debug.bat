...
:: This batch file builds libdatachannel from source code using MSVC (cl.exe) for Debug.

:: Set the root folder as the location of this script
set "LIBDATACHANNEL_ROOT=%~dp0"
set "BUILD_DIR=%LIBDATACHANNEL_ROOT%build-debug"
set "INSTALL_DIR=%LIBDATACHANNEL_ROOT%install-debug"
...
:: Success message
echo [SUCCESS] libdatachannel built and installed successfully (Debug).
echo -------------------------------------------------
